...
function(_setup_obs_studio)
  ...
  if(OS_WINDOWS)
    ...
    if(CMAKE_GENERATOR MATCHES "^Visual Studio")
      set(_cmake_platform_args -A "${arch},version=${CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION}")
    endif()
    ...
    if(CMAKE_CROSSCOMPILING)
      list(
        ...
        -DCMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION_MAXIMUM=${CMAKE_VS_WINDOWS_TARGET_PLATFORM_VERSION_MAXIMUM}
      )
    endif()
  elseif(OS_MACOS)
    set(_cmake_generator "Xcode")
    set(_cmake_platform_args "-DCMAKE_OSX_ARCHITECTURES:STRING=arm64\;x86_64")
  ...
  execute_process(
    COMMAND
      ...
      "${dependencies_dir}/${_obs_destination}/build_${arch}" -G ${_cmake_generator} ${_cmake_platform_args}
  ...
  if(CMAKE_CROSSCOMPILING)
    execute_process(
      COMMAND
        "${CMAKE_COMMAND}" --install build_${arch} --component Development --config RelWithDebInfo --prefix
        "${dependencies_dir}"
      WORKING_DIRECTORY "${dependencies_dir}/${_obs_destination}"
      RESULT_VARIABLE _process_result
      COMMAND_ERROR_IS_FATAL ANY
